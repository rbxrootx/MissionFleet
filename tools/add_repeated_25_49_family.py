"""Stage every unmatched byte-identical routine from 25 through 49 bytes."""

import json

from tools.add_call_stubs import append_records
from tools.add_repeated_50_99_family import (
    BASE, COMPONENTS, CONFIG_DIR, REGION_DIR, ROOT, decode,
)
...
def discover_targets():
    ...
    groups = find_groups(
        ...
        load_matched(CONFIG_DIR / "matches.json"), regions, BASE, 25, 49, 2,
    )
    return tuple(
...
def main():
    ...
    for component, address, size in TARGETS:
        ...
        source = f"src/{component}/matches/RecoveredRepeated25To49{address.upper()}.cpp"
