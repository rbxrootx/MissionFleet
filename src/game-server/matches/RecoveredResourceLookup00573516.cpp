...
extern "C" __declspec(naked) void Recovered00573516()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push ecx
...
loc_00573554:
    ...
    __asm je loc_00573568
    __asm mov ecx, dword ptr [ebp - 4]
    __asm add ecx, 0x20
    __asm mov dword ptr [ebp - 4], ecx
    __asm jmp loc_00573554
loc_00573568:
    __asm mov edx, dword ptr [ebp + 8]
    __asm mov eax, dword ptr [ebp - 4]
...
loc_0057357C:
    ...
    __asm jne loc_0057359B
    __asm push 0xbf
    __asm push offset ResourceAssertFile005CBCC4
    __asm call Recovered00534A00
    __asm test eax, eax
    __asm je loc_0057359B
    __asm _emit 0cch
loc_0057359B:
    __asm xor edx, edx
    __asm test edx, edx
