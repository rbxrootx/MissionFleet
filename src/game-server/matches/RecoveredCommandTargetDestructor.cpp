...
extern "C" char Handler0057CB39;
extern "C" char Vtable00583140;
extern "C" char File005C5B58;
extern "C" void Assert00534A00();
extern "C" void BaseDestroy005309A7();
extern "C" __declspec(naked) void Recovered004F7D3B()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Handler0057CB39
    ...
    __asm push 34h
    __asm push offset File005C5B58
    ...
    __asm mov ecx, dword ptr [ebp-10h]
    __asm call BaseDestroy005309A7
