...
extern "C" unsigned char ThrowTemplate004B0320;
extern "C" void (*ThrowImport004B0320)();
extern "C" __declspec(naked) void AllocCall004B0320()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm sub esp, 20h
    ...
    __asm push edi
    __asm mov ecx, 8
    __asm mov esi, offset ThrowTemplate004B0320
    ...
    __asm push edx
    __asm call dword ptr [ThrowImport004B0320]
    __asm pop edi
    __asm pop esi
    __asm mov esp, ebp
    __asm pop ebp
