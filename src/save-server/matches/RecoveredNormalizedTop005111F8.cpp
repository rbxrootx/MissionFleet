...
extern "C" void *Data0058C7A2;
extern "C" void *Data006352D0;
// Exact recovered relocation-normalized call wrapper.
extern "C" __declspec(naked) void Recovered005111F8()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Data0058C7A2
    ...
    __asm mov dword ptr [eax], offset Data006352D0
