extern "C" void Call0046F610();
// Exact recovered repeated medium routine.
extern "C" __declspec(naked) void Recovered004705C0()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push ecx
    ...
    __asm jmp loc_00470615
loc_00470602:
    __asm mov edx, dword ptr [ebp + 0xc]
    __asm push edx
    __asm mov eax, dword ptr [ebp + 8]
    __asm push eax
    __asm call Call0046F610
    __asm add esp, 8
    __asm mov dword ptr [ebp - 4], eax
loc_00470615:
    __asm cmp dword ptr [ebp - 4], -1
    __asm jne loc_00470626
    __asm mov ecx, dword ptr [ebp + 0x10]
    __asm mov dword ptr [ecx], 0xffffffff
    __asm jmp loc_00470633
loc_00470626:
