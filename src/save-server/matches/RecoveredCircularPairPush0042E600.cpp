// Exact recovered two-word circular-queue insertion.
extern "C" __declspec(naked) void Recovered0042E600()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm sub esp, 0ch
    ...
    __asm mov edx, dword ptr [ebp-8]
    __asm mov edx, dword ptr [edx+14h]
    __asm mov esi, dword ptr [ebp-4]
    __asm mov dword ptr [edx+esi*8], eax
    __asm mov dword ptr [edx+esi*8+4], ecx
    __asm mov eax, dword ptr [ebp-8]
