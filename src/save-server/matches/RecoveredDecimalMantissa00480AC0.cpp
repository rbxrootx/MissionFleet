extern "C" void Recovered004809F0();
extern "C" void Recovered00480940();
// Exact recovered decimal mantissa builder.
extern "C" __declspec(naked) void Recovered00480AC0()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm sub esp, 10h
