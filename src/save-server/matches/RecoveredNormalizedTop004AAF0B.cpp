...
extern "C" void *Data0058C928;
extern "C" void *Data00635FEC;
// Exact recovered relocation-normalized call wrapper.
extern "C" __declspec(naked) void Recovered004AAF0B()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Data0058C928
    ...
    __asm mov dword ptr [eax], offset Data00635FEC
