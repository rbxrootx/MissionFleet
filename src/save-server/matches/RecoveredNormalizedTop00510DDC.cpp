...
extern "C" void *Data0058C78F;
extern "C" void *Data00635114;
// Exact recovered relocation-normalized call wrapper.
extern "C" __declspec(naked) void Recovered00510DDC()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Data0058C78F
    ...
    __asm mov dword ptr [eax], offset Data00635114
