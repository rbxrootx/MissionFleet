...
extern "C" __declspec(naked) void Recovered0044F936()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm sub esp, 0xc
...
loc_0044F97B:
    ...
    __asm test ecx, ecx
    __asm je loc_0044F9A3
    __asm mov word ptr [ebp - 4], 8
    __asm mov dx, word ptr [ebp + 0xc]
    __asm and dx, 0x7fff
    __asm mov word ptr [ebp + 0xc], dx
    __asm jmp loc_0044F9BE
loc_0044F9A3:
    __asm mov eax, dword ptr [ebp + 0xc]
    __asm and eax, 0xffff
    __asm cmp eax, 9
    __asm jne loc_0044F9B8
    __asm mov word ptr [ebp - 4], 8
    __asm jmp loc_0044F9BE
loc_0044F9B8:
