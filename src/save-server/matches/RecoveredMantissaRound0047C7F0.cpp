extern "C" void Recovered0047C6B0();
extern "C" void Recovered0047C740();
// Exact recovered mantissa rounding/truncation helper.
extern "C" __declspec(naked) void Recovered0047C7F0()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm sub esp, 1ch
