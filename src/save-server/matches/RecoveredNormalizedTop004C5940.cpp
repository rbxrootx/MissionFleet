...
extern "C" void *Data0058C099;
extern "C" void *Data006345D4;
extern "C" void *Data00671270;
// Exact recovered relocation-normalized call wrapper.
extern "C" __declspec(naked) void Recovered004C5940()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Data0058C099
    ...
    __asm mov dword ptr [eax], offset Data006345D4
loc_004C5977:
    __asm cmp dword ptr [ebp + 8], 0
    __asm jg loc_004C598E
    __asm push 0x25
    __asm push offset Data00671270
    __asm call Call00528D40
    __asm test eax, eax
    __asm je loc_004C598E
    __asm _emit 0cch
loc_004C598E:
    __asm xor ecx, ecx
    __asm test ecx, ecx
    __asm jne loc_004C5977
