...
extern "C" void *Data0058C93B;
extern "C" void *Data006360B0;
// Exact recovered relocation-normalized call wrapper.
extern "C" __declspec(naked) void Recovered004AB039()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Data0058C93B
    ...
    __asm mov dword ptr [eax], offset Data006360B0
