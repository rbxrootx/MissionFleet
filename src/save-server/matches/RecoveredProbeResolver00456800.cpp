...
extern "C" unsigned char ProbeFile00456800;
extern "C" unsigned char ProbeExpr00456800;
extern "C" void Report0046CE60();
extern "C" __declspec(naked) void Probe00456800()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm sub esp, 8
    ...
    __asm jne checked
    __asm push offset ProbeExpr00456800
    __asm push 0
    __asm push 2348
    __asm push offset ProbeFile00456800
    __asm push 2
    __asm call Report0046CE60
    __asm add esp, 20
    __asm cmp eax, 1
    __asm jne checked
    __asm int 3
