...
extern "C" void *Data0058C822;
extern "C" void *Data00635CD4;
// Exact recovered relocation-normalized call wrapper.
extern "C" __declspec(naked) void Recovered004A93B2()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Data0058C822
    ...
    __asm mov dword ptr [eax], offset Data00635CD4
