...
extern "C" void *Data0058C99A;
extern "C" void *Data0063648C;
// Exact recovered relocation-normalized call wrapper.
extern "C" __declspec(naked) void Recovered004AB935()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Data0058C99A
    ...
    __asm mov dword ptr [eax], offset Data0063648C
