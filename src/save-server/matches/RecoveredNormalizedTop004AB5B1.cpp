...
extern "C" void *Data0058C987;
extern "C" void *Data006363C4;
// Exact recovered relocation-normalized call wrapper.
extern "C" __declspec(naked) void Recovered004AB5B1()
{
    __asm push ebp
    __asm mov ebp, esp
    __asm push -1
    __asm push offset Data0058C987
    ...
    __asm mov dword ptr [eax], offset Data006363C4
