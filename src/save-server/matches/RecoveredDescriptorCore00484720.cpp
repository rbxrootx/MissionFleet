...
extern "C" int Table00689064;
extern "C" void *Import0068B690;
extern "C" void *Import0068B3DC;
extern "C" __declspec(naked) void Recovered00484720()
{
    ...
    __asm push edi
    __asm push ebp
    __asm mov ecx, dword ptr [eax*4+Table00689064]
    __asm mov edi, dword ptr [esp+36]
    __asm push ecx
    __asm push edi
    __asm call dword ptr [Import0068B690]
    __asm mov esi, eax
    ...
    __asm push 0
    __asm push edi
    __asm call dword ptr [Import0068B3DC]
    __asm flag_one:
    __asm mov eax, dword ptr [ebx+12]
    __asm mov dword ptr [esp+28], eax
