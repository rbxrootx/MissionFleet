...
extern "C" int Table00451424;
extern "C" void *Import0043C050;
extern "C" void *Import0043C094;
extern "C" __declspec(naked) void Recovered00429150()
{
    ...
    __asm push edi
    __asm push ebp
    __asm mov ecx, dword ptr [eax*4+Table00451424]
    __asm mov edi, dword ptr [esp+36]
    __asm push ecx
    __asm push edi
    __asm call dword ptr [Import0043C050]
    __asm mov esi, eax
    ...
    __asm push 0
    __asm push edi
    __asm call dword ptr [Import0043C094]
    __asm flag_one:
    __asm mov eax, dword ptr [ebx+12]
    __asm mov dword ptr [esp+28], eax
